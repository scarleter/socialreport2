...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>public/plugins/datatables/buttons.dataTables.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>public/plugins/datatables/responsive.bootstrap.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>public/plugins/datatables/dataTables.bootstrap.min.css">
  <!-- layer -->
  <link rel="stylesheet" href="<?= base_url() ?>public/plugins/layer/skin/layer.css">
...
<script src="<?= base_url() ?>public/plugins/datatables/responsive.bootstrap.min.js"></script>
...
<script src="<?= base_url() ?>public/plugins/datatables/jszip.min.js"></script>
<!-- layer -->
<script src="<?= base_url() ?>public/plugins/layer/layer.min.js"></script>
<!-- cookies -->
<script src="<?= base_url() ?>public/plugins/cookies/cookies.js"></script>
<!-- AdminLTE App -->
